...
module.exports = {
    ...
    execute(interaction, client) {
      ...
      if(db.fetch(`Bakım`)) {
          ...
          if(interaction.user.id !== "924369071070404668" && interaction.user.id !== "924369071070404668" && interaction.user.id !== "924369071070404668" && interaction.user.id !== "924369071070404668" && interaction.user.id !== "990186530767249419"){
      ...
      const Kullanamazsın = new EmbedBuilder()
            ...
            if (timestampt.has(interaction.user.id)) {
                ...
                if (now < expiration) {
                    ...
                    const embeduyarı = new EmbedBuilder()
                        .setDescription(`<:carpi:1117083838590492772> Bu komutu tekrar kullanabilmek için **${timeleft} saniye** beklemelisin.`)
                        .setColor('Red')
                        .setTitle("Hata")
        ...
        if (command.yetki) {
            ...
            var yetkiyok = new EmbedBuilder()
                .setDescription(`<:carpi:1117083838590492772> Bu komutu kullanabilmek için **${yetki}** yetkisine sahip olmalısın.`)
                .setColor('Red')
                .setTitle("Hata")
        ...
        if (command.botyetki) {
            ...
            var botyetkiyok = new EmbedBuilder()
                .setDescription(`\<:carpi:1117083838590492772> Bu komutu kullanabilmek için **${botyetki}** yetkisine sahip olmalıyım.`)
                .setColor('Red')
                .setTitle("Hata")
