...
module.exports = {
    ...
    execute(message, client) {
        ...
        if(db.fetch(`Bakım`)) {
          ...
          if(message.author.id !== "924369071070404668" && message.author.id !== "924369071070404668" && message.author.id !== "924369071070404668" && message.author.id !== "924369071070404668" && message.author.id !== "990186530767249419"){
